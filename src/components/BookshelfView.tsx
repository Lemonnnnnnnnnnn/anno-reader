 ...
 * Handles book import, book selection, and book removal.
 */
...
interface BookshelfViewProps {
  onBookSelect: (book: BookshelfItem) => void;
}

export function BookshelfView({ onBookSelect }: BookshelfViewProps) {
  ...
  const handleImport = useCallback(async () => {
    try {
      ...
      await addBook(book);
      setBook(book);
      onBookSelect({ ...book, progress: null });
    } catch (err) {
