...
export function BookCard({ book, onClick, onRemove }: BookCardProps) {
  ...
  return (
    <>
      <div
        className="flex flex-col bg-surface dark:bg-surface-dark rounded-lg overflow-hidden cursor-pointer transition-all shadow-sm border border-border dark:border-border-dark w-[180px] hover:shadow-md"
        onClick={handleClick}
      ...
      >
        ...
        <div className="p-3 flex flex-col gap-1">
          <h3 className="m-0 text-sm font-semibold text-text dark:text-text-dark leading-tight truncate" title={book.title}>
            {book.title}
          </h3>
          <p className="m-0 text-xs text-text-secondary dark:text-text-secondary-dark truncate" title={book.author}>
            {book.author}
          </p>
          ...
          {book.progress && (
            <div className="flex items-center gap-2 mt-1">
              <div className="flex-1 h-1 bg-border dark:bg-border-dark rounded-full overflow-hidden">
                <div
              ...
              <span className="text-[0.7rem] text-text-muted dark:text-text-muted-dark min-w-[32px] text-right">
